<script lang="ts">
	...
	const pengumuman = [
		...
		{ id: 3, judul: 'Pendaftaran Ekstrakurikuler', tanggal: '20 Sep 2026', kategori: 'Kegiatan' }
	];
</script>
...
<div class="space-y-5 px-4">
	...
	<div class="flex items-center gap-3 pt-1">
		...
		<div>
			<h1 class="text-xl font-black text-primary">Selamat datang, {nama}!</h1>
	...
	<div class="rounded-2xl border-2 border-slate-200 bg-white p-4 shadow-sm">
		<a
			href={resolve('/admin')}
			class="flex w-full items-center justify-center gap-2 rounded-2xl border-b-4 border-b-[#1f8ba3] bg-secondary py-3 text-sm font-black text-white transition-all duration-150 active:translate-y-0.5 active:border-b-2"
		>
			Pergi ke Portal Admin
		</a>
	</div>
</div>
